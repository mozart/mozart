...
OZ_BI_define(gfs_projector_4,4,0){
  ...
  IntView __i = intOrIntView(OZ_in(2));
...
OZ_BI_define(gfs_projector_5,5,0){
  ...
  BoolView __bv = boolOrBoolView(OZ_in(3));
    ...
    IntView __i = intOrIntView(OZ_in(3));
...
OZ_BI_define(gfs_rel_3,3,0){
  ...
  for(int i=0; i<3; i++)
    SuspendPostingOnLTR(OZ_in(i));
  if(OZ_isSetOpType(OZ_in(0)) && OZ_isSetVarArgs(OZ_in(1)) && 
...
OZ_BI_define(gfs_rel_4,4,0){
  ...
  if(OZ_isGeSetVar(OZ_in(0)) && OZ_isSetRelType(OZ_in(1)) && 
    ...
    SetView __y = setOrSetView(OZ_in(3));
    try{
...
OZ_BI_define(gfs_rel_5,5,0){
  ...
  if(OZ_isGeSetVar(OZ_in(0)) && OZ_isSetOpType(OZ_in(1)) && 
    ...
    SetView __x = setOrSetView(OZ_in(0));
    SetView __y = setOrSetView(OZ_in(2));
    SetView __z = setOrSetView(OZ_in(4));
    try{
...
OZ_BI_define(gfs_convexHull_2,2,0){
  ...
  SetView __x = setOrSetView(OZ_in(0));
  SetView __y = setOrSetView(OZ_in(1));
  try{
...
OZ_BI_define(gfs_sequentialUnion_2,2,0){
  ...
  if(OZ_isSetVarArgs(OZ_in(0)) && OZ_isGeSetVar(OZ_in(1))){
    ...
    */
    ...
    SetView __x = setOrSetView(OZ_in(1));
    try{
...
OZ_BI_define(gfs_min_2,2,0){
  ...
  if(OZ_isGeSetVar(OZ_in(0)) && OZ_isGeIntVar(OZ_in(1))){
    ...
    */  
    SetView __s = setOrSetView(OZ_in(0));
    IntView __x = intOrIntView(OZ_in(1));
    try{
...
OZ_BI_define(gfs_weights_4,4,0){
  ...
  if(OZ_isIntArgs(OZ_in(0)) && OZ_isIntArgs(OZ_in(1)) &&
    ...
    */
    ...
    SetView __x = setOrSetView(OZ_in(2));
...
OZ_BI_define(gfs_elementsUnion_3,3,0){
  ...
  SetView __y = setOrSetView(OZ_in(1));
  SetView __z = setOrSetView(OZ_in(2));
...
OZ_BI_define(gfs_element_3,3,0){
  ...
  IntView __y = intOrIntView(OZ_in(1));
  SetView __z = setOrSetView(OZ_in(2));
