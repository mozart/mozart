...
pkgdatadir = $(datadir)/gtk-canvas
pkglibdir = $(libdir)/gtk-canvas
pkgincludedir = $(includedir)/gtk-canvas
...
GENCAT = @GENCAT@
GLIB_CFLAGS = -I/usr/lib/glib/include -I/usr/X11R6/include
GLIB_LIBS = -L/usr/lib -lglib
GMOFILES = @GMOFILES@
GMSGFMT = @GMSGFMT@
GTKDOC = false
GTK_CANVAS_IDLDIR = 
GTK_CANVAS_INCLUDEDIR = 
GTK_CANVAS_LIBDIR = 
GTK_CANVAS_LIBS = -lgtk-canvas -lart_lgpl -L/usr/lib -lgdk_imlib -L/usr/lib -L/usr/X11R6/lib -lgtk -lgdk -rdynamic -lgmodule -lglib -ldl -lXi -lXext -lX11 -lm -L/usr/lib -L/usr/X11R6/lib -lgtk -lgdk -rdynamic -lgmodule -lglib -ldl -lXi -lXext -lX11 -lm
...
INTLLIBS = @INTLLIBS@
INTLOBJS = @INTLOBJS@
LIBGTK_CANVAS_LIBS = -L/usr/lib -lgdk_imlib -L/usr/lib -L/usr/X11R6/lib -lgtk -lgdk -rdynamic -lgmodule -lglib -ldl -lXi -lXext -lX11 -lm -L/usr/lib -L/usr/X11R6/lib -lgtk -lgdk -rdynamic -lgmodule -lglib -ldl -lXi -lXext -lX11 -lm
LIBOBJS = @LIBOBJS@
...
test_gtk_canvas = test
#test_gtk_canvas = 

SUBDIRS = libart_lgpl 	gtk-canvas 	test


include_HEADERS = gtk-canvas.h
