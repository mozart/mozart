...
define
   local
      ...
      GtkCanvasInitStub = ["char oz_module_name[] = \"GtkCanvasNative\";"
			   ...
			   "fprintf(stderr, \"GtkCanvasInit:calling gdk_init\n \");"
			   "fflush(stderr);"
			   "\tgdk_init(0, 0);"
			   "fprintf(stderr, \"GtkCanvasInit:calling gtk_init\n\");"
			   "fflush(stderr);"
			   "\tgtk_init(0, 0);"
			   "fprintf(stderr, \"GtkCanvasInit:calling gtk_canvas_init\n \");"
			   "fflush(stderr);"
			   "\tgtk_canvas_init();"
			   "fprintf(stderr, \"passed gtk_canvas_init\n\");"
			   "fflush(stderr);"
