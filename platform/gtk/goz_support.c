...
static GtkType gtk_canvas_type_register_boxed (const gchar *name) {
  GtkTypeInfo info;
...
static void gtk_canvas_type_init() {
  int i;
...
OZ_BI_define (ozgtk_canvas_init, 0, 0)
{
  gtk_canvas_init();
  return OZ_ENTAILED;
} OZ_BI_end
