...
void AM::handleToplevelBlocking(ProgramCounter PC)
{
  prefixError();
  message("******************************************\n");
  ...
  message("\n");
  currentThread->printDebug(PC,NO,10000);
  message("******************************************\n");
