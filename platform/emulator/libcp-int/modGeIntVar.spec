...
####
'linear_IVA_IRT_In_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IVA_IRT_In_ICL}
,

'linear_IVA_IRT_IV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IVA_IRT_IV_ICL}
,

'linear_IVA_IRT_In_BV_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IVA_IRT_In_BV_ICL}
,

'linear_IVA_IRT_IV_BV_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IVA_IRT_IV_BV_ICL}
,

'linear_IA_IVA_IRT_In_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IA_IVA_IRT_In_ICL}
,

'linear_IA_IVA_IRT_IV_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IA_IVA_IRT_IV_ICL}
,

'linear_IA_IVA_IRT_In_BV_ICL'=> { in => ['+value','+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IA_IVA_IRT_In_BV_ICL}
,

'linear_IA_IVA_IRT_IV_BV_ICL'=> { in => ['+value','+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_IA_IVA_IRT_IV_BV_ICL}
,

'linear_BVA_IRT_In_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => linear_BVA_IRT_In_ICL}
,

'linear_BVA_IRT_IV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
...
'eq_IV_In_ICL'=> { in => ['+value','+value','+value'],
		 out=>[],
		 bi => eq_IV_In_ICL}
,

'eq_IV_IV_BV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => eq_IV_IV_BV_ICL}
,

'eq_IV_In_BV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => eq_IV_In_BV_ICL}
,

'eq_IVA_ICL'=> { in => ['+value','+value'],
		 out=>[],
		 bi => eq_IVA_ICL}
,

'count_IVA_In_IRT_In_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => count_IVA_In_IRT_In_ICL}
,

'count_IVA_IV_IRT_In_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => count_IVA_IV_IRT_In_ICL}
,

'count_IVA_In_IRT_IV_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => count_IVA_In_IRT_IV_ICL}
,

'count_IVA_IV_IRT_IV_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => count_IVA_IV_IRT_IV_ICL}
,

'gcc_IVA_IA_InS_InS_InS_InS_InS_ICL'=> { in => ['+value','+value','+value','+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => gcc_IVA_IA_InS_InS_InS_InS_InS_ICL}
,

'gcc_IVA_IA_InS_InS_InS_InS_ICL'=> { in => ['+value','+value','+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => gcc_IVA_IA_InS_InS_InS_InS_ICL}
,

'gcc_IVA_InS_InS_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => gcc_IVA_InS_InS_ICL}
,

'gcc_IVA_InS_ICL'=> { in => ['+value','+value','+value'],
		 out=>[],
		 bi => gcc_IVA_InS_ICL}
,

'gcc_IVA_IVA_InS_InS_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => gcc_IVA_IVA_InS_InS_ICL}
,

'gcc_IVA_IA_IVA_InS_InS_InS_BlS_InS_InS_ICL'=> { in => ['+value','+value','+value','+value','+value','+value','+value','+value','+value','+value'],
		 out=>[],
...
'dom_IVA_InS_InS_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
...
'bool_eq_BV_BV_ICL'=> { in => ['+value','+value','+value'],
		 out=>[],
		 bi => bool_eq_BV_BV_ICL}
,

'bool_and_BV_BV_BV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_and_BV_BV_BV_ICL}
,

'bool_and_BV_BV_Bl_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_and_BV_BV_Bl_ICL}
,

'bool_or_BV_BV_BV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_or_BV_BV_BV_ICL}
,

'bool_or_BV_BV_Bl_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_or_BV_BV_Bl_ICL}
,

'bool_imp_BV_BV_BV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_imp_BV_BV_BV_ICL}
,

'bool_imp_BV_BV_Bl_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_imp_BV_BV_Bl_ICL}
,

'bool_eqv_BV_BV_BV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_eqv_BV_BV_BV_ICL}
,

'bool_eqv_BV_BV_Bl_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_eqv_BV_BV_Bl_ICL}
,

'bool_xor_BV_BV_BV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_xor_BV_BV_BV_ICL}
,

'bool_xor_BV_BV_Bl_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => bool_xor_BV_BV_Bl_ICL}
,

'sortedness_IVA_IVA_ICL'=> { in => ['+value','+value','+value'],
		 out=>[],
		 bi => sortedness_IVA_IVA_ICL}
,

'sortedness_IVA_IVA_IVA_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => sortedness_IVA_IVA_IVA_ICL}
,

'distinct_IVA_ICL'=> { in => ['+value','+value'],
		 out=>[],
		 bi => distinct_IVA_ICL}
,
...
'rel_IV_IRT_In_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => rel_IV_IRT_In_ICL}
,

'rel_IV_IRT_IV_BV_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => rel_IV_IRT_IV_BV_ICL}
,

'rel_IV_IRT_In_BV_ICL'=> { in => ['+value','+value','+value','+value','+value'],
		 out=>[],
		 bi => rel_IV_IRT_In_BV_ICL}
,

'rel_IVA_IRT_IVA_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => rel_IVA_IRT_IVA_ICL}
,

'min_IV_IV_IV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => min_IV_IV_IV_ICL}
,

'min_IVA_IV_ICL'=> { in => ['+value','+value','+value'],
		 out=>[],
		 bi => min_IVA_IV_ICL}
,

'max_IV_IV_IV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
		 bi => max_IV_IV_IV_ICL}
,

'max_IVA_IV_ICL'=> { in => ['+value','+value','+value'],
		 out=>[],
		 bi => max_IVA_IV_ICL}
,

'abs_IV_IV_ICL'=> { in => ['+value','+value','+value'],
		 out=>[],
		 bi => abs_IV_IV_ICL}
,

'mult_IV_IV_IV_ICL'=> { in => ['+value','+value','+value','+value'],
		 out=>[],
