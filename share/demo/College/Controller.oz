...
in
   proc {Controller}
      ...
      MB0 MB1 MB2 MB3
      M0 M1 M2 M3
      AAbout AExit ALoadProblem AEditProblem ALoadSolution ASaveSolution
      AConstraints AFirstSol AOptimize
      AIntrOpt ADispGraphical ADispBrowsing
      ADispTextual APrintGraphical APrintTextual
   ...
   in
      ...
      {ForAll [[ALoadProblem DoFileOp readProblem read]
...
%              [AOptimize Compute optimizeProblem graphic]
               ...
               [APrintGraphical TimeTable grab none]
               [APrintTextual TimeTable print none]]
       proc {$ Action}
...
\endif
      ...
      {ForAll [ ["  Display graphical " ADispGraphical]
                ...
                ["--------------"]
                ["  Print graphical " APrintGraphical]
                ["  Print textual  " APrintTextual] ]
       proc{$ C}
          case C.1
