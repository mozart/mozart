...
-b, --browse
    ...
    browse the local HTML.  If no mep arguments are given, this
    will browse MEP 0.

-i, --install
    After generating the HTML, install it and the plaintext source file
    (.txt) on mozart-oz.org.  In that case the user's name is used in the scp
...
-l, --local
    ...
    when logged in to the mozart-oz.org machine (grizzly).
...
The optional arguments ``meps`` are either mep numbers or .txt files.
"""
...
MEPURL = 'mep-%04d.html'
MEPCVSURL = ()
#('http://cvs.sourceforge.net/cgi-bin/viewcvs.cgi/python/python'
#             '/nondist/meps/mep-%04d.txt')
MEPDIRRUL = 'http://www.mozart-oz.org/meps/'


HOST = "www.mozart-oz.org"                    # host for update
HDIR = "/services/mozart/httpd/html/meps" # target host directory
LOCALVARS = "Local Variables:"

COMMENT = """<!--
This HTML is auto-generated.  DO NOT EDIT THIS FILE!  If you are writing a new
MEP, see http://www.mozart-oz.org/meps/mep-0001.html for instructions and links
...
fixpat = re.compile("((https?|ftp):[-_a-zA-Z0-9/.+~:?#$=&,]+)|(mep-\d+(.txt)?)|"
                    "(RFC[- ]?(?P<rfcnum>\d+))|"
                    "(MEP\s+(?P<mepnum>\d+))|"
                    ".")
...
def fixfile(inpath, input_lines, outfile):
    ...
    print >> outfile, (
        ...
        '<a href="../" title="Mozart Home Page">\n'
        '<img src="../pics/PyBanner%03d.gif" alt="[Mozart]"\n'
        ' border="0" width="150" height="35" /></a></td>\n'
        '<td class="textlinks" align="left">\n'
        '[<b><a href="../">Mozart Home</a></b>]' % r)
    if basename <> 'mep-0000.txt':
        print >> outfile, '[<b><a href=".">MEP Index</a></b>]'
    if mep:
        try:
